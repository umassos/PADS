...
def run_manager(log_file_batch, batch_ref_input):
    ...
    total_cpu_bandwidth = curr_number_of_core * 100
    batch_cpu_bandwidth = int(total_cpu_bandwidth * 1.0)
    ...
    for _ in range(EXPERIMENT_TOTAL_ITERATION):
        for _ in range(EXPERIMENT_REPEAT_TIMES):
            # if iteration_counter == 11 or iteration_counter == 21 or iteration_counter == 31:
            ...
            print("Blast progress log file is cleared for the initialization purpose.")
